...
<jsp:useBean id="beanLook" class="test.ApplyLookBean" scope="session" />
...
<center><table border="1">
  <tr>
    ...
    <th>申请日期</th>
        ...
        id = beanLook.getId();
        Bnumber = beanLook.getBnumber();
        type = beanLook.getType();
        descrip = beanLook.getDescrip();
        agreeFlag = beanLook.getAgreeFlag();
        typeA = beanLook.getTypeA();
        typeB = beanLook.getTypeB();
        typeC = beanLook.getTypeC();
        chec = beanLook.getChec();
        date = beanLook.getDate();
        %>
        <%
            String status = "";
            String flag = "";

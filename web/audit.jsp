...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%-- 从session中取出bean--%>
        <jsp:useBean id="bean" class="test.AuditBean" scope="session" />
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="con">
    <div class="middle">
        <form action="doAudit" method="post">
            <style type="text/css">
table
{
...
<center><table border="1">
 ...
 <tr>
    ...
    <th>当前状态</th>
        ...
        id = bean.getId();
        Bnumber = bean.getBnumber();
        type = bean.getType();
        descrip = bean.getDescrip();
        agreeFlag = bean.getAgreeFlag();
        typeA = bean.getTypeA();
        typeB = bean.getTypeB();
        typeC = bean.getTypeC();
        %>
...
<option value="1" selected>不同意</option>
<option value="2">同意</option>
</select>
            </td>
            <%

...
public class ImgSaveConti extends HttpServlet {
    String Bid;
    ...
    protected void doPost(HttpServletRequest request,
        ...
        //连接数据库
         try{
           ...
           String sqlSelect = "select path from imgConti where check = 0";
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                       ...
                       filePath = uploadPath + File.separator + fileName;
                        ...
                        String strInsert = "insert into imgConti(path) VALUES ('"+temp+"','"+username+"')";
                        sql.executeUpdate(strInsert);
                        String strQuery = "select id from imgConti where path = '"+temp+"'";
                        ...
                        Bid = value;}
                        String strUpBid = "update imgConti set Bid = '"+value+"' where id = '"+id+"'";
      ...
      //getServletContext().getRequestDispatcher("DoBase64").forward(request, response);
        ...
        response.sendRedirect("DoBase64Conti?Bid="+Bid);
        }catch(Exception ex){

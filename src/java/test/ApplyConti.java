 ...
 * @author Windows10
 */
public class ApplyConti extends HttpServlet {
 protected void doPost(HttpServletRequest request,HttpServletResponse response) 
           ...
           String sqlQuery = "insert into applyconti(typeA,typeB,typeC,numBegin,numEnd,descrip,username)values('"+typeA+"','"+typeB+"','"+typeC+"','"+numBegin+"','"+numEnd+"','"+descrip+"','"+username+"')";
           sql.executeUpdate(sqlQuery);
            //重定向
            response.sendRedirect("applyConti.jsp");
